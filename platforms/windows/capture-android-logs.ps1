...
$script:RepositoryRoot = Split-Path -Parent (Split-Path -Parent $script:ToolRoot)
$script:RuntimeRoot = Join-Path $script:RepositoryRoot "_runtime\windows"
$script:ResultsRoot = Join-Path $script:RepositoryRoot "results\windows"
